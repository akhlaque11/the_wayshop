            ...
            <div class="box-content">
                ...
                <div class="span4 text-right" class="table table-striped table-bordered">
                    ...
                    <table class="table table-striped table-bordered">
                        <tr>
                            <td>Shpping Name : </td>
                            <td><?php echo $shipping_info->shipping_first_name; ?></td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        foreach ($order_details_info as $single_order_details) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $single_order_details->product_sale_quantity ?></td>
                                <td>Rs.<?php echo $this->cart->format_number($single_order_details->product_price * $single_order_details->product_sale_quantity) ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                    <tfooter>
