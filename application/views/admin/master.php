...
<body>
            ...
            <div id="sidebar-left" class="span2">
                <div class="nav-collapse sidebar-nav">
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        <li><a href="<?php echo base_url('admin_dashboard')?>"><i class="icon-dashboard"></i><span
                        ...
                        <li><a href="<?php echo base_url('product/manage_product')?>"><i class="icon-eye-open"></i><span
                                    class="hidden-tablet"> Manage Product</span></a></li>

                        <li><a href="<?php echo base_url('slider/add_slider')?>"><i class="icon-font"></i><span
                                    class="hidden-tablet"> Add Slider</span></a></li>
                        <li><a href="<?php echo base_url('slider/manage_slider')?>"><i class="icon-picture"></i><span
                                    class="hidden-tablet"> Manage Slider</span></a></li>
                        <li style="display:none;"><a href="<?php echo base_url('themeoption');?>"><i class="icon-align-justify"></i><span
                                    class="hidden-tablet"> Theme Option</span></a></li>
                        <li><a href="<?php echo base_url('manageOrder/manage_order');?>"><i class="icon-calendar"></i><span
                                    class="hidden-tablet"> Manage Order</span></a></li>
                    </ul>
                </div>
            </div>
            <!-- end: Main Menu -->
    ...
    <footer>
        ...
        <p>
            <center>
                <span>&copy; <?php echo date("Y"); ?> Ecommerce CodeIgniter - Bootstrap Template By <a
                        href="http://jiji262.github.io/Bootstrap_Metro_Dashboard/" style="color:white;"
