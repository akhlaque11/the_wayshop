...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('edit/product/'.$product_info_by_id->id)?>">edit Product</a>
        </li>
    </ul>
        ...
        <div class="box span12">
            ...
            <div class="box-content">
                <form name="formName" class="form-horizontal"
                    action="<?php echo base_url('product/update_product/'.$product_info_by_id->id);?>"
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span6 typeahead" value="<?php echo $product_info_by_id->p_name;?>"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="product_short_description" id="textarea2" rows="2">
                                    <?php echo $product_info_by_id->p_short_description;?>
                                </textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="product_long_description" id="textarea2" rows="4">
                                    <?php echo $product_info_by_id->p_long_description;?>
                                </textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span6 typeahead" name="p_image" id="fileInput" type="file" />
                                <input class="span6 typeahead" name="product_delete_image"
                                    value="<?php echo base_url('assets/product_images/'.$product_info_by_id->p_image);?>"
                                    type="hidden" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <img src="<?php echo base_url('assets/product_images/'.$product_info_by_id->p_image);?>"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span6 typeahead" value="<?php echo $product_info_by_id->p_price;?>"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span6 typeahead"
                                    value="<?php echo $product_info_by_id->p_qty;?>" name="product_quantity"
                            ...
                            <div class="controls">
                                <select id="product_category" name="product_category">
                                    ...
                                    <option value="<?php echo $single_category->id;?>">
                                        <?php echo $single_category->c_name;?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="controls">
                                <select id="product_brand" name="product_brand">
                                    ...
                                    <option value="<?php echo $single_brand->id;?>">
                                        <?php echo $single_brand->b_name;?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
